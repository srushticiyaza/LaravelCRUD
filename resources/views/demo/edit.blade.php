        ...
        <div class="row justify-content-center">
            <div class="col-sm-8 ">
                <div class="mt-5 p-1 border">
                    <h3 class="text-muted">Edit #{{ $demo->demo }}</h3>
                    <div class="card mt-3 p-3 shadow-lg">
                        <form method="POST" action="/demo/{{ $demo->id }}/update" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="font-bold m-5 ">
                                ...
                                <input type="text" name="state"
                                    class="form-control "value="{{ old('state', $demo->state) }}" />
                                @if ($errors->has('state'))
